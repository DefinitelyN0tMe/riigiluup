 ...
 *
 * <ol>
 *   <li>If {@code RIIGILUUP_IT_JDBC_URL} is set → connect to that URL directly.
...
public class IntegrationDbSelector
    ...
    private static final String EXTERNAL_JDBC_URL = System.getenv("RIIGILUUP_IT_JDBC_URL");
    private static final String EXTERNAL_USER =
            System.getenv().getOrDefault("RIIGILUUP_IT_JDBC_USER", "riigiluup");
    private static final String EXTERNAL_PASSWORD =
            System.getenv().getOrDefault("RIIGILUUP_IT_JDBC_PASSWORD", "riigiluup");
    ...
    public void initialize(ConfigurableApplicationContext ctx) {
        ...
        if (EXTERNAL_JDBC_URL != null && !EXTERNAL_JDBC_URL.isBlank()) {
            ...
            props.put("riigiluup.it.backend", "external");
        } else {
            ...
            props.put("riigiluup.it.backend", "testcontainers");
        }
            ...
            synchronized (IntegrationDbSelector.class) {
                ...
                if (local == null) {
                    local = new PostgreSQLContainer<>("postgres:16.4-alpine3.20")
                            .withDatabaseName("riigiluup_it")
                            .withUsername("riigiluup")
                            .withPassword("riigiluup")
                            .withReuse(true);
                    local.start();
